...
Но индексных файлов в проекте может быть много и они пораждают длинные цепочки циклических зависимостей, например:
...
Такие цепочки приводят к тому, что, когда программа упала из-за ошибки в циклической зависимости, ты смотришь в стектрейс и, вообще, даже не представляешь где?, что? и с чем? пересеклось.
